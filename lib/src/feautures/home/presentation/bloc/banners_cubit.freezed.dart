...
mixin _$BannersState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<BannerDTO> banners) loadedState,
...
class _$_InitialState implements _InitialState {
  ...
  @override
  String toString() {
    return 'BannersState.initialState()';
  }
...
abstract class _InitialState implements BannersState {
...
class _$_LoadedState implements _LoadedState {
  const _$_LoadedState({required final List<BannerDTO> banners})
      : _banners = banners;
  ...
  @override
  String toString() {
    return 'BannersState.loadedState(banners: $banners)';
  }
...
abstract class _LoadedState implements BannersState {
  const factory _LoadedState({required final List<BannerDTO> banners}) =
      _$_LoadedState;
...
class _$_EmptyState implements _EmptyState {
  ...
  @override
  String toString() {
    return 'BannersState.emptyState()';
  }
...
abstract class _EmptyState implements BannersState {
...
class _$_LoadingState implements _LoadingState {
  ...
  @override
  String toString() {
    return 'BannersState.loadingState()';
  }
...
abstract class _LoadingState implements BannersState {
...
class _$_ErrorState implements _ErrorState {
  ...
  @override
  String toString() {
    return 'BannersState.errorState(message: $message)';
  }
...
abstract class _ErrorState implements BannersState {
