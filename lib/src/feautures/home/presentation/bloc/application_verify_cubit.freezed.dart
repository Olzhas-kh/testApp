...
mixin _$ApplicationVerifyState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int catId, List<AnswerPayload> answers)
        loadedState,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(int catId, List<AnswerPayload> answers)? loadedState,
...
abstract class _$$_LoadedStateCopyWith<$Res> {
  ...
  $Res call({int catId, List<AnswerPayload> answers});
}
...
class _$_LoadedState implements _LoadedState {
  const _$_LoadedState(
      {required this.catId, required final List<AnswerPayload> answers})
      : _answers = answers;
  ...
  @override
  String toString() {
    return 'ApplicationVerifyState.loadedState(catId: $catId, answers: $answers)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loadedState(catId, answers);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loadedState?.call(catId, answers);
  }
...
abstract class _LoadedState implements ApplicationVerifyState {
  const factory _LoadedState(
      ...
      required final List<AnswerPayload> answers}) = _$_LoadedState;
