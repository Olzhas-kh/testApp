...
class CustomSegmentedControl<T> extends StatefulWidget {
  CustomSegmentedControl({
    ...
    this.kThumbRadius = _kThumbRadius,
  ...
  @override
  State<CustomSegmentedControl<T>> createState() => _SegmentedControlState<T>();
}

class _SegmentedControlState<T> extends State<CustomSegmentedControl<T>>
    with TickerProviderStateMixin<CustomSegmentedControl<T>> {
  ...
  @override
  void didUpdateWidget(CustomSegmentedControl<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
        ...
        child: AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            return _SegmentedControlRenderWidget<T>(
              ...
              state: this,
              kThumbRadius: widget.kThumbRadius,
              children: children,
            );
          },
        ),
